...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { name: 'Tạp Chí', to: '/blog' },
    { name: 'Về HuLi', to: '/about' },
  ];
            ...
            >
              <div className="px-4 pt-2 pb-6 space-y-1">
                ...
                <button
                  ...
                  className="block w-full text-left px-3 py-3 text-base font-medium text-gray-600 hover:text-black hover:bg-gray-50 uppercase tracking-wide cursor-pointer"
                >
                  Tài Khoản
                </button>
              </div>
